...
def animate(i):
    ...
    plt.title('V_Det vs. Tx_Output_Power (Lin-Log)', fontdict={'fontsize':13})
    plt.xlabel('Output Power (dBm)', fontsize=9)
    plt.ylabel('V_Det (mV)', fontsize=9)
