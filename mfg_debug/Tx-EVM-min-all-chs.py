...
# Qorvo Bias List
Q_DAC_12_a = np.arange(0.0, 0.15,0.1)               # -30C test
#Q_DAC_12_a = np.arange(0.0,8.12,0.1)
Q_DAC_3_a  = np.arange(0.0, 0.15,0.1)
...
#fieldnames = ["Freq", "EVM", "POWER"]
fieldnames = ["Freq", "Ch0_EVM", "Ch0_POWER", "Ch1_EVM", "Ch1_POWER"]
...
for Path in Paths:
    ...
    FREQ_RANGES = [37.1E9, 38.5e9, 39.5e9, 39.9E9]
            ...
            for Q_DAC_12 in Q_DAC_12_a:
                ...
                for Q_DAC_3 in Q_DAC_3_a:
                    ...
                    if Path == 2 and minEVM > EVM:
                        ...
                        Ch0_tempQ = tempQ 
                        Ch0_tempM = tempM 
                        info = {"Freq": FREQ/1e9, "Ch0_EVM": Ch0_EVM, "Ch0_POWER": Ch0_Output_Power}
                        csv_writer.writerow(info)
                           
                    
                    elif Path == 3 and minEVM > EVM:
                        minEVM = EVM
                        Ch1_EVM = minEVM  
                        Ch1_Output_Power = Output_Power 
                        Ch1_Qorvo_I = Qorvo_I 
                        Ch1_CHA3398_I = CHA3398_I 
                        Ch1_Q_DAC_12 = Q_DAC_12 
                        Ch1_Q_DAC_3  = Q_DAC_3 
                        Ch1_C_DAC = C_DAC 
                        Ch1_tempQ =  tempQ 
                        Ch1_tempM = tempM 
                        info = {"Freq": FREQ/1e9, "Ch1_EVM": Ch1_EVM, "Ch1_POWER": Ch1_Output_Power}
                        csv_writer.writerow(info)                                
    ...
    #info = {"Freq": FREQ/1e9, "Ch0_EVM": minEVM, "Ch0_POWER": minOutput_Power, "Ch1_EVM": minEVM, "Ch1_POWER": minOutput_Power}
#       info = {"Freq": FREQ/1e9, "Ch0_EVM": Ch0_EVM, "Ch0_POWER": Ch0_Output_Power, "Ch1_EVM": Ch1_EVM, "Ch1_POWER": Ch1_Output_Power}
